export function LegacyUIStack({ className = "" }: { className?: string }) {
  return (
    <div className={`relative w-full h-full min-h-[350px] ${className}`}>
      ...
      {/* Card 1 - Map app (back) */}
      <div
        className="absolute w-48 h-36 bg-gray-100 rounded-lg shadow-md border border-gray-200 overflow-hidden"
        style={{
          top: "10%",
          left: "5%",
      ...
      {/* Card 2 - Review app */}
      <div
        className="absolute w-44 h-40 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden"
        style={{
          top: "20%",
          left: "25%",
      ...
      >
        <div className="h-6 bg-yellow-100 flex items-center px-2">
      ...
      <div
        className="absolute w-52 h-44 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden"
        style={{
          top: "35%",
          left: "15%",
      ...
      <div
        className="absolute w-48 h-32 bg-white rounded-lg shadow-2xl border border-gray-300 overflow-hidden"
        style={{
          top: "55%",
          left: "35%",
